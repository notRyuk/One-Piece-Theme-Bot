...
from OnePieceBot import telethn as SaitamaTelethonClient, TIGER_USERS, SUDO_USERS, SUPPORT_USERS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
      #Update the link of your chat disaster levels here after the href
